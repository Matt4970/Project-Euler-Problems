...
int main(void){
   ...
   // Check Diagonal, Slanting Down and to the Right TODO
   for (int y = 0; y < 17; y++){
      for (int x = 0; x < 17; x++){
   ...
   // Check Diagonal, Slanting Down to the Left
   for (int y = 0; y < 17; y++){
      for (int x = 3; x < 20; x++){
         sum = GRID[y][x] * GRID[y + 1][x - 1] * GRID[y + 2][x - 2] * GRID[y + 3][x - 3];
         if (sum > largest_sum) largest_sum = sum;
   ...
   // printf("%i", GRID[10][10] * GRID[10][11] * GRID[10][12] * GRID[10][13]);
   printf("The largest sum is %i.", largest_sum);
   return 0;
}